	...
	<form method="post" encType="multipart/form-data">
		<table summary="게시판 수정">
			...
			<tbody>
				...
				<tr>
					<th>이름</th>
					<td><input type="text" name="writer" size="12"  value="${bovo.writer}"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="content" cols="50" 
							rows="8" id="content">${bovo.content}</textarea></td>
				</tr>
				<tr>
					<th>첨부파일</th>
					<c:choose>
						...
						<c:otherwise>
							<td><input type="file" name="file"><b>${bovo.f_name}</b></td>
						         <input type="hidden" name="f_name" value="${bovo.f_name}">	
						</c:otherwise>
					</c:choose>
				</tr>
				<tr>
