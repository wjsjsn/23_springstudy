			...
			<tbody>
				...
				<tr>
					...
					<c:choose>
						...
						<c:otherwise>
							<td><a href="/bbs_down.do?f_name=${bvo.f_name}" target="_blank"><img  src="/resources/images/${bvo.f_name}" style="80px"></a></td>
						</c:otherwise>
					</c:choose>
				</tr>
				<tr>
					<td colspan="2">
						...
						<input style="background-color: lightgray; outline: none; border: 1px solid gray;" type="button" value="수정" onclick="update_go(this.form)">
						<input style="background-color: lightgray; outline: none; border: 1px solid gray;"  type="button" value="삭제" onclick="delete_go(this.form)">
